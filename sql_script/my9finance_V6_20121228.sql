...
INSERT INTO log_resolve VALUES ('15', '4', '账号己禁用,联系管理员开启.');
...
-- ----------------------------
-- Table structure for `mantype`
-- ----------------------------
DROP TABLE IF EXISTS `mantype`;
CREATE TABLE `mantype` (
  `ID` int(4) NOT NULL AUTO_INCREMENT,
  `F_id` int(4) NOT NULL,
...
-- ----------------------------
-- Table structure for `record_lib`
-- ----------------------------
DROP TABLE IF EXISTS `record_lib`;
