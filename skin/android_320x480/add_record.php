<script type="text/javascript" src="../../JavaScript/TwoSelect.js"></script>
...
*/
	...
	if  ( $recordtype = $_GET['add_type'] == 'out_record' )
	{
		...
		echo "支出说明:&nbsp;";
		echo "<script>GlobalError=\"TEST\";</script>";
...
echo "<input type=\"button\" name=\"add\" value=\"添加\"\ onClick=\"scity()\">";
?>
